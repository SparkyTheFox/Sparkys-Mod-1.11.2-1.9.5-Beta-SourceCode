...
public class Util {
  ...
  public static String resource(String res) {
    return String.format("%s:%s", getModelResource(null, null), res);
  }

  public static ResourceLocation getResource(String res) {
    return new ResourceLocation(RESOURCE_PREFIX, res);
  }
  ...
  public static String prefix(String name) {
    return String.format("%s.%s", RESOURCE_PREFIX, name.toLowerCase(Locale.US));
  }
