...
public class ItemAuzSpaceSuit extends ItemArmor {

	public ItemAuzSpaceSuit(ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		if (slot == EntityEquipmentSlot.HEAD || slot == EntityEquipmentSlot.CHEST || slot == EntityEquipmentSlot.FEET) {
			return ServerMod.MOD_ID + ":textures/armor/auz_1.png";
		} else if (slot == EntityEquipmentSlot.CHEST || slot == EntityEquipmentSlot.LEGS) {
			return ServerMod.MOD_ID + ":textures/armor/auz_2.png";
		} else {
			return null;
	}
		}
	  ...
	  if (itemStack.getItem().equals(ModItems.AuzzySpaceChestplate))
