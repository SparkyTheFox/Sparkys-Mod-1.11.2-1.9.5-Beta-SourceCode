...
public class ItemLapisArmor extends ItemArmor {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		if (slot == EntityEquipmentSlot.HEAD || slot == EntityEquipmentSlot.CHEST || slot == EntityEquipmentSlot.FEET) {
			return ServerMod.MOD_ID + ":textures/armor/lapis_1.png";
		} else if (slot == EntityEquipmentSlot.CHEST || slot == EntityEquipmentSlot.LEGS) {
			return ServerMod.MOD_ID + ":textures/armor/lapis_2.png";
		} else {
			return null;
	}
		}
...
*/
				// TODO Auto-generated method stub
		        		...
		        		public void addRecipes() {
		        			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.LapisHelmet), "LLL", "L L", "   ", 'L', "dyeBlue"));	
		        		{
		        			
		        		}
		        			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.LapisChestplate), "L L", "LLL", "LLL", 'L',"dyeBlue"));
		
			        	{
			        			
			        	}
			        		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.LapisLeggings), "LLL", "LLL", "L L", 'L', "dyeBlue"));	
		
			        	{
			        			
			        	}
		        	
			        		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.LapisBoots), "   ", "L L", "L L", 'L', "dyeBlue"));	
