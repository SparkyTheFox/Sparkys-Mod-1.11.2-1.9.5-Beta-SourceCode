...
public class ItemPlanetesSpaceSuit extends ItemArmor {

	public ItemPlanetesSpaceSuit(ArmorMaterial materialIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		if (slot == EntityEquipmentSlot.HEAD || slot == EntityEquipmentSlot.CHEST || slot == EntityEquipmentSlot.FEET) {
			...
			return ServerMod.MOD_ID + ":textures/armor/planetessuit_layer_2_jumper.png";
		} else {
			return null;
	}
		}
