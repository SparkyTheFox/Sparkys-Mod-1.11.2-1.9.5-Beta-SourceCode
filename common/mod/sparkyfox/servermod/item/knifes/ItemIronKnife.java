...
public class ItemIronKnife extends ItemSword {
    ...
    public ItemIronKnife(ToolMaterial material, float attackSpeed) {
        super(material);;
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		return "IronKnife" + ServerMod.RESOURCE_PREFIX + ModNames.IronKnife;
	}
...
public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
  ...
  return false;
	...
	public void addRecipes() {
		GameRegistry.addShapedRecipe(new ItemStack(this), " I ", " S ", " L ", 'I', Items.IRON_INGOT, 'S',
