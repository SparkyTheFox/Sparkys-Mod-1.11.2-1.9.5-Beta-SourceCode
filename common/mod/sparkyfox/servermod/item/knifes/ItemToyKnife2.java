...
public class ItemToyKnife2<ITooltipFlag> extends ItemSword {
    ...
    public ItemToyKnife2(ToolMaterial material, float attackSpeed) {
        super(material);
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		return "ToyKnife2" + ServerMod.RESOURCE_PREFIX + ModNames.ToyKnife2;
	}
	
	@Override
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
        tooltip.add(TextFormatting.BLUE + "Made of plastic. A rarity nowadays.");
