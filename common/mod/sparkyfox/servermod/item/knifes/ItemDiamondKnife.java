...
public class ItemDiamondKnife extends ItemSword {
    ...
    public ItemDiamondKnife(ToolMaterial material, float attackSpeed) {
        super(material);;
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		return "DiamondKnife" + ServerMod.RESOURCE_PREFIX + ModNames.DiamondKnife;
	}
...
public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
  ...
  return false;
	...
	public void addRecipes() {
		GameRegistry.addShapedRecipe(new ItemStack(this), " D ", " S ", " L ", 'D', Items.DIAMOND, 'S',
