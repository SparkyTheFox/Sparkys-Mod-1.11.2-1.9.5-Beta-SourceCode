...
public class ItemStoneKnife extends ItemSword {
    ...
    public ItemStoneKnife(ToolMaterial material, float attackSpeed) {
        super(material);;
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		return "StoneKnife" + ServerMod.RESOURCE_PREFIX + ModNames.StoneKnife;
	}
...
public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot equipmentSlot) {
  ...
  return false;
	...
	public void addRecipes() {
		GameRegistry.addShapedRecipe(new ItemStack(this), " B ", " S ", " L ", 'B', Blocks.COBBLESTONE, 'S',
