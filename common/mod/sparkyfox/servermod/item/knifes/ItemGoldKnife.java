...
public class ItemGoldKnife extends ItemSword {
    ...
    public ItemGoldKnife(ToolMaterial material, float attackSpeed) {
        super(material);
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		return "GoldKnife" + ServerMod.RESOURCE_PREFIX + ModNames.GoldKnife;
	}
	...
	public void addRecipes() {
		GameRegistry.addShapedRecipe(new ItemStack(this), " G ", " S ", " L ", 'G', Items.GOLD_INGOT, 'S',
