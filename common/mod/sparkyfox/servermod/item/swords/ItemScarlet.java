...
public class ItemScarlet extends ItemSword {
    ...
    public ItemScarlet(ToolMaterial material, float attackSpeed) {
        super(material);;
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		return "Scarlet" + ServerMod.RESOURCE_PREFIX + ModNames.Scarlet;
	}
