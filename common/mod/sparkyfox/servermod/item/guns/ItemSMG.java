...
public class ItemSMG extends ItemBasic {
...
///////////////////////////////////////////	 
      ...
      public float apply(ItemStack stack, World worldIn, EntityLivingBase entityIn) {
        ...
        // return (itemstack != null) && (itemstack.getItem() == ItemSMG.this) ? (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F : 0.0F;
         ...
         return entityIn == null ? -10.0F : (entityIn.getActiveItemStack().getItem() != ItemSMG.this ? -10.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F);//20.0F
      }	  
