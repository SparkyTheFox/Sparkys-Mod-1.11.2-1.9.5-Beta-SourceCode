...
public class ItemSniperRounds extends Item {
	...
	return "SniperRounds" + ServerMod.RESOURCE_PREFIX + ModNames.SniperRounds; 
		
	}
		
		 public ItemSniperRounds()
		    {
		    ...
		    public boolean isInfinite(ItemStack stack, ItemStack bow, net.minecraft.entity.player.EntityPlayer player)
		    {
		        ...
		        return enchant <= 0 ? false : this.getClass() == ItemSniperRounds.class;
		    }
