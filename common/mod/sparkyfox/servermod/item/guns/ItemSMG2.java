...
public class ItemSMG2 extends ItemBasic {
	
	 @Override
	 public String getUnlocalizedName(ItemStack stack) {
	 	return "SMG2" + ServerMod.RESOURCE_PREFIX + ModNames.SMG2;
	 }
...
///////////////////////////////////////////	 
      ...
      public float apply(ItemStack stack, World worldIn, EntityLivingBase entityIn) {
        ...
        // return (itemstack != null) && (itemstack.getItem() == ItemSMG.this) ? (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F : 0.0F;
         ...
         return entityIn == null ? -10.0F : (entityIn.getActiveItemStack().getItem() != ItemSMG2.this ? -10.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F);//20.0F
      }	  
...
///////////////////////////////////////////	  
  public void onUsingTick(ItemStack stack, EntityLivingBase entity, int count) {
     ...
     playSound(entity, ModSoundEvents.smg2, 0.9F, itemRand.nextFloat() * 0.3F + 0.8F);
