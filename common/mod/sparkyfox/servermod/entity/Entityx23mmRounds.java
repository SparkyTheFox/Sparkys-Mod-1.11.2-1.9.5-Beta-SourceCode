...
public abstract class Entityx23mmRounds extends EntityArrow implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(Entityx23mmRounds.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public Entityx23mmRounds.PickupStatus pickupStatus;
    ...
    public Entityx23mmRounds(World worldIn)
    {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = Entityx23mmRounds.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
        this.setSize(0.5F, 0.5F);
    }

    public Entityx23mmRounds(World worldIn, double x, double y, double z)
    {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    public Entityx23mmRounds(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = Entityx23mmRounds.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == Entityx23mmRounds.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = Entityx23mmRounds.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? Entityx23mmRounds.PickupStatus.ALLOWED : Entityx23mmRounds.PickupStatus.DISALLOWED;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == Entityx23mmRounds.PickupStatus.ALLOWED || this.pickupStatus == Entityx23mmRounds.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == Entityx23mmRounds.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static Entityx23mmRounds.PickupStatus getByOrdinal(int ordinal)
        {
