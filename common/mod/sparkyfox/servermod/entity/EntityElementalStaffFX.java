...
/* 19 */     this.z = d2;
     float[] colors;
/* 21 */     float[] colors1; if (color <= 15) {
/* 22 */       colors1 = net.minecraft.entity.passive.EntitySheep.getDyeRgb(net.minecraft.item.EnumDyeColor.byDyeDamage(color));
     } else
/* 24 */       colors1 = new float[] { (color >> 16 & 0xFF) / 255.0F, (color >> 8 & 0xFF) / 255.0F, (color & 0xFF) / 255.0F };
/* 25 */     this.particleRed = colors1[0];
/* 26 */     this.particleGreen = colors1[1];
/* 27 */     this.particleBlue = colors1[2];
