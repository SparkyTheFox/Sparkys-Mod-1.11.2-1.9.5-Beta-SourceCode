...
public abstract class EntitySMGRounds extends EntityArrow implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntitySMGRounds.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntitySMGRounds.PickupStatus pickupStatus;
    ...
    public EntitySMGRounds(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = EntitySMGRounds.PickupStatus.ALLOWED;
        }
    }
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntitySMGRounds.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntitySMGRounds.PickupStatus.ALLOWED : EntitySMGRounds.PickupStatus.DISALLOWED;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntitySMGRounds.PickupStatus.ALLOWED || this.pickupStatus == EntitySMGRounds.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == EntitySMGRounds.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static EntitySMGRounds.PickupStatus getByOrdinal(int ordinal)
        {
