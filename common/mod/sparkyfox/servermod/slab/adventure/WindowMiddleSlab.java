 ...
 *
 */
public abstract class WindowMiddleSlab extends BlockSlab {
	 ...
	 */
	public WindowMiddleSlab(String unlocalizedName) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModSlab.WindowMiddleSlabHalf);
	}
