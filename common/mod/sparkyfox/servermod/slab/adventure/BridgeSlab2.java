...
public abstract class BridgeSlab2 extends BlockSlab //NEEDS to be abstract (for some reason :P)
{
	public BridgeSlab2(String name, float hardness, float resistance)
	{
		super(Material.IRON);
