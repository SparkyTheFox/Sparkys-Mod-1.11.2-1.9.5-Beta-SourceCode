...
public abstract class BridgeSlab3 extends BlockSlab //NEEDS to be abstract (for some reason :P)
{
	public BridgeSlab3(String name, float hardness, float resistance)
	{
		super(Material.IRON);
