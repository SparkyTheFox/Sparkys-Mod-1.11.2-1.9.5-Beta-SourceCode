...
public abstract class BridgeSlab4 extends BlockSlab //NEEDS to be abstract (for some reason :P)
{
	public BridgeSlab4(String name, float hardness, float resistance)
	{
		super(Material.IRON);
