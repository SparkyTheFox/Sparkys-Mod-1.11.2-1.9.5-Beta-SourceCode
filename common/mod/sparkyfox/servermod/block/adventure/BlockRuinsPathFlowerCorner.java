...
public class BlockRuinsPathFlowerCorner extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsPathFlowerCorner" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsPathFlowerCorner;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsPathFlowerCorner() {							  	  //===================================================================================================================//
