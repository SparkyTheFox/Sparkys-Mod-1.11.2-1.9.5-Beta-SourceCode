...
public class BlockRuinsDoorPillar7 extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "BlockRuinsDoorPillar7" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoorPillar7;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoorPillar7() {							  	  //===================================================================================================================//
		super(Material.BARRIER);					  			 // The Material determines some properties of the block.															  //
		this.setBlockUnbreakable();				 				// The hardness determines how long a block takes to break. 5 is a bit high, most are around 2-7.					 //
