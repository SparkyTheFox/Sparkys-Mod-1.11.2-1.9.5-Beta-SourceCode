...
public class BlockRuinsWallCracked extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallCracked" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallCracked;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsWallCracked() {							  //===================================================================================================================//
