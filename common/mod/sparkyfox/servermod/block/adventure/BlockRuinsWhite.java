...
public class BlockRuinsWhite extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWhite" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWhite;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWhite() {							  	  //===================================================================================================================//
