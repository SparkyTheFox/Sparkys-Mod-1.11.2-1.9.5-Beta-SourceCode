...
public class BlockRuinsLightGrey extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsLightGrey" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsLightGrey;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsLightGrey() {							  	  //===================================================================================================================//
