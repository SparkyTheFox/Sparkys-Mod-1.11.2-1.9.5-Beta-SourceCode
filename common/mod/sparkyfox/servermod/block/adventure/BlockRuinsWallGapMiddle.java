...
public class BlockRuinsWallGapMiddle extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallGapMiddle" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallGapMiddle;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallGapMiddle() {							  	  //===================================================================================================================//
