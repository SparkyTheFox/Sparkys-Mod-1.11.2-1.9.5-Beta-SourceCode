...
public class BlockRuinsDoor3BottomLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoor3BottomLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoor3BottomLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoor3BottomLeft() {							  	  //===================================================================================================================//
