...
public class BlockRuinsFadedWallTopVentLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallTopVentLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallTopVentLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsFadedWallTopVentLeft() {							  	  //===================================================================================================================//
