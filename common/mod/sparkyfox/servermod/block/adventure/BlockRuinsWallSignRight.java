...
public class BlockRuinsWallSignRight extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallSignRight" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallSignRight;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallSignRight() {							  	  //===================================================================================================================//
