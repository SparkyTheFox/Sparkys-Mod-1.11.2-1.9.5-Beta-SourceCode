...
public class BlockRuinsDoorTopLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoorTopLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoorTopLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoorTopLeft() {							  	  //===================================================================================================================//
