...
public class BlockRuinsHalfCircle extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsHalfCircle" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsHalfCircle;  // BrassBlock.ServerMod:BrassBlock
	}
	


	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsHalfCircle() {							  		  //===================================================================================================================//
