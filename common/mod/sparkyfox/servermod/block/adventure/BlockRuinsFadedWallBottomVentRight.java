...
public class BlockRuinsFadedWallBottomVentRight extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallBottomVentRight" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallBottomVentRight;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsFadedWallBottomVentRight() {							  	  //===================================================================================================================//
