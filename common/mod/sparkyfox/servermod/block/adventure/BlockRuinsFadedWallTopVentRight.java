...
public class BlockRuinsFadedWallTopVentRight extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallTopVentRight" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallTopVentRight;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsFadedWallTopVentRight() {							  	  //===================================================================================================================//
