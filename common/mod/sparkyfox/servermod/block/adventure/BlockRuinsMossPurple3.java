...
public class BlockRuinsMossPurple3 extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsMossPurple3" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsMossPurple3;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsMossPurple3() {							  	  //===================================================================================================================//
		...
		this.setSoundType(SoundType.PLANT);   			  	  // Sound type effects placing, breaking, and step sounds.														   	   //
