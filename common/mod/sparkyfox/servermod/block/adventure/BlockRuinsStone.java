...
public class BlockRuinsStone extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsStone" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsStone;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsStone() {							  	  //===================================================================================================================//
