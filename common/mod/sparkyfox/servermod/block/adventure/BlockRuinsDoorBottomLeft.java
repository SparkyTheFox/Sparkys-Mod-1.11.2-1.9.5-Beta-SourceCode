...
public class BlockRuinsDoorBottomLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoorBottomLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoorBottomLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoorBottomLeft() {							  	  //===================================================================================================================//
