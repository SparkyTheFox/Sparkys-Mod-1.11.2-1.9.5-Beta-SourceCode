...
public class BlockRuinsDoorMiddleLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoorMiddleLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoorMiddleLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoorMiddleLeft() {							  	  //===================================================================================================================//
