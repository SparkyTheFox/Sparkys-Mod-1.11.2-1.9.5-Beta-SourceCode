...
public class BlockRuinsWallMouseHouse extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallMouseHouse" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallMouseHouse;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallMouseHouse() {							  	  //===================================================================================================================//
