...
public class BlockRuinsGrey extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsGrey" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsGrey;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsGrey() {							  	  //===================================================================================================================//
