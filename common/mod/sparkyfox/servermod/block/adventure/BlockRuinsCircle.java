...
public class BlockRuinsCircle extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsCircle" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsCircle;  // BrassBlock.ServerMod:BrassBlock
	}
	


	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsCircle() {							  		  //===================================================================================================================//
