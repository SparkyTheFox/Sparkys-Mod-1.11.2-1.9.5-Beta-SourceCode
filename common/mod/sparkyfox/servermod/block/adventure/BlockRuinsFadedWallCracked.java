...
public class BlockRuinsFadedWallCracked extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallCracked" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallCracked;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsFadedWallCracked() {						  //===================================================================================================================//
