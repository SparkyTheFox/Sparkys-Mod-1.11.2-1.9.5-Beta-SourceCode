...
public class BlockYellowFlowers extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "YellowFlowers" + ServerMod.RESOURCE_PREFIX + ModNames.YellowFlowers;  // BrassBlock.ServerMod:BrassBlock
	}
    ...
    {
        entityIn.fall(fallDistance, 0.10F);
    }
}
