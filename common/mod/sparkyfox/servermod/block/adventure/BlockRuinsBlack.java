...
public class BlockRuinsBlack extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsBlack" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsBlack;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsBlack() {							  		  //===================================================================================================================//
