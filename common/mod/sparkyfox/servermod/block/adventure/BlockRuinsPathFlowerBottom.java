...
public class BlockRuinsPathFlowerBottom extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsPathFlowerBottom" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsPathFlowerBottom;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsPathFlowerBottom() {							  	  //===================================================================================================================//
