...
public class BlockRuinsWallSign extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallSign" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallSign;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallSign() {							  	  //===================================================================================================================//
