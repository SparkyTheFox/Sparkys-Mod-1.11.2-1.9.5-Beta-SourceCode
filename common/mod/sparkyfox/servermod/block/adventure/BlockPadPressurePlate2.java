...
public class BlockPadPressurePlate2 extends BlockPressurePlateWeighted {

	@Override
	public String getUnlocalizedName() {
		return "PadPressurePlate2" + ServerMod.RESOURCE_PREFIX + ModNames.PadPressurePlate2;  // CobaltOre.ServerMod:CobaltOre
	}
	
	private final BlockPressurePlate.Sensitivity sensitivity;

	public BlockPadPressurePlate2(Material materialIn, BlockPressurePlate.Sensitivity sensitivityIn) {
