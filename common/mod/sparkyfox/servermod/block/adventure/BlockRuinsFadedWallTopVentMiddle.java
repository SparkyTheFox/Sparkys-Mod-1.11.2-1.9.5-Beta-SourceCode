...
public class BlockRuinsFadedWallTopVentMiddle extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallTopVentMiddle" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallTopVentMiddle;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsFadedWallTopVentMiddle() {							  	  //===================================================================================================================//
