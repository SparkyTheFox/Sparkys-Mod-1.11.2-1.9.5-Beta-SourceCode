...
public class BlockRuinsDoor2Bottom extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoor2Bottom" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoor2Bottom;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoor2Bottom() {							  	  //===================================================================================================================//
