...
public class BlockRuinsFadedWallBottomVentLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallBottomVentLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallBottomVentLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsFadedWallBottomVentLeft() {							  	  //===================================================================================================================//
