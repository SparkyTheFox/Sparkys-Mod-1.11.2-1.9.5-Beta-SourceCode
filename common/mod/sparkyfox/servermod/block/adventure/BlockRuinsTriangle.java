...
public class BlockRuinsTriangle extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsTriangle" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsTriangle;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsTriangle() {							  	  //===================================================================================================================//
