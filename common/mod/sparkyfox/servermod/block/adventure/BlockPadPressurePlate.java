...
public class BlockPadPressurePlate extends BlockPressurePlateWeighted {

	@Override
	public String getUnlocalizedName() {
		return "PadPressurePlate" + ServerMod.RESOURCE_PREFIX + ModNames.PadPressurePlate;  // CobaltOre.ServerMod:CobaltOre
	}
	
	private final BlockPressurePlate.Sensitivity sensitivity;

	public BlockPadPressurePlate(Material materialIn, BlockPressurePlate.Sensitivity sensitivityIn) {
