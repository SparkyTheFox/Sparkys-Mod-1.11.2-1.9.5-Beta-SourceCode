...
public class BlockRuinsBridge extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsBride" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsBridge;  // BrassBlock.ServerMod:BrassBlock
	}
	


	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsBridge() {							  		  //===================================================================================================================//
