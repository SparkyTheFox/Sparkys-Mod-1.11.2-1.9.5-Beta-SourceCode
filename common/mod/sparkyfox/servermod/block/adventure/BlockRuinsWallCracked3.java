...
public class BlockRuinsWallCracked3 extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallCracked3" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallCracked3;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsWallCracked3() {							  		  //===================================================================================================================//
