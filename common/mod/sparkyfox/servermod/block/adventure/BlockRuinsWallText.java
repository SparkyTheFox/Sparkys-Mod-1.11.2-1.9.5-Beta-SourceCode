...
public class BlockRuinsWallText extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallText" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallText;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallText() {							  	  //===================================================================================================================//
