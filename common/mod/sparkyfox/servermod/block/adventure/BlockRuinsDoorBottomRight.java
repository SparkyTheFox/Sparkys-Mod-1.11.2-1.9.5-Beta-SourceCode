...
public class BlockRuinsDoorBottomRight extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoorBottomRight" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoorBottomRight;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoorBottomRight() {							  	  //===================================================================================================================//
