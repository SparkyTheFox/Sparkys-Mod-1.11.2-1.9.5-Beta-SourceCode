...
public class BlockPadPressurePlate4 extends BlockPressurePlateWeighted {

	@Override
	public String getUnlocalizedName() {
		return "PadPressurePlate4" + ServerMod.RESOURCE_PREFIX + ModNames.PadPressurePlate4;  // CobaltOre.ServerMod:CobaltOre
	}
	
	private final BlockPressurePlate.Sensitivity sensitivity;

	public BlockPadPressurePlate4(Material materialIn, BlockPressurePlate.Sensitivity sensitivityIn) {
