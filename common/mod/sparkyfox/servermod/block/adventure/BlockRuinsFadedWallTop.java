...
public class BlockRuinsFadedWallTop extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallTop" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallTop;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsFadedWallTop() {							  		  //===================================================================================================================//
