...
public class BlockRuinsWallSignLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallSignLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallSignLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallSignLeft() {							  	  //===================================================================================================================//
