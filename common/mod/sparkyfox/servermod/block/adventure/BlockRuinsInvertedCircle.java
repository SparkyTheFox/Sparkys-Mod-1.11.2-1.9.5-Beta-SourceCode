...
public class BlockRuinsInvertedCircle extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsInvertedCircle" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsInvertedCircle;  // BrassBlock.ServerMod:BrassBlock
	}
	


	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsInvertedCircle() {							  		  //===================================================================================================================//
