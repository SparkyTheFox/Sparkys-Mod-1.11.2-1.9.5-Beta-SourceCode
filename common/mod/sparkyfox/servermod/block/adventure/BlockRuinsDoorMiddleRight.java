...
public class BlockRuinsDoorMiddleRight extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoorMiddleRight" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoorMiddleRight;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoorMiddleRight() {							  	  //===================================================================================================================//
