...
public class BlockRuinsWallBottom extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallBottom" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallBottom;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsWallBottom() {							  		  //===================================================================================================================//
