...
public class BlockSwitch3 extends BlockLever {

	@Override
	public String getUnlocalizedName() {
		return "WallSwitch3" + ServerMod.RESOURCE_PREFIX + ModNames.Switch3;  // CobaltOre.ServerMod:CobaltOre
	}
	public BlockSwitch3() {
		super();
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            worldIn.playSound((EntityPlayer)null, pos, ModSoundEvents.nosound, SoundCategory.BLOCKS, 1.0F, 1.0F);
