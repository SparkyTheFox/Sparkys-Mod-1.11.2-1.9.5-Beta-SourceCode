...
public class BlockRuinsPathFlowerSide extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsPathFlowerSide" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsPathFlowerSide;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsPathFlowerSide() {							  	  //===================================================================================================================//
