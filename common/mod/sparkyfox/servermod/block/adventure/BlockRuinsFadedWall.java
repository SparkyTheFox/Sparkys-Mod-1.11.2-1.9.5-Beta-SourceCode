...
public class BlockRuinsFadedWall extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWall" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWall;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsFadedWall() {							  	  //===================================================================================================================//
