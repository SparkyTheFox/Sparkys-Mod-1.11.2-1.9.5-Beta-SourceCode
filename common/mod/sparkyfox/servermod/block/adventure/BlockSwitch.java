...
public class BlockSwitch extends BlockLever {
	...
	public String getUnlocalizedName() {
		return "WallSwitch" + ServerMod.RESOURCE_PREFIX + ModNames.Switch;  // CobaltOre.ServerMod:CobaltOre
	}
	public BlockSwitch() {
		super();
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            worldIn.playSound((EntityPlayer)null, pos, ModSoundEvents.switch2, SoundCategory.BLOCKS, 1.0F, 1.0F);
