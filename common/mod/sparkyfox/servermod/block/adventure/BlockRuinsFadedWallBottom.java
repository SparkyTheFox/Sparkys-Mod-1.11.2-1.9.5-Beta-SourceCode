...
public class BlockRuinsFadedWallBottom extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallBottom" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallBottom;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsFadedWallBottom() {							  		  //===================================================================================================================//
