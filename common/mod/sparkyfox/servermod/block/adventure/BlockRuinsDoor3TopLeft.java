...
public class BlockRuinsDoor3TopLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoor3TopLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoor3TopLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoor3TopLeft() {							  	  //===================================================================================================================//
