...
public class BlockRuinsDoorTopRight extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoorTopRight" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoorTopRight;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoorTopRight() {							  	  //===================================================================================================================//
