...
public class BlockRuinsWall extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWall" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWall;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsWall() {							  		  //===================================================================================================================//
