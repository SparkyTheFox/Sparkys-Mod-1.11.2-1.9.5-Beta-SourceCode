...
public class BlockRuinsFadedWallBottomVentMiddle extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsFadedWallBottomVentMiddle" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsFadedWallBottomVentMiddle;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsFadedWallBottomVentMiddle() {							  	  //===================================================================================================================//
