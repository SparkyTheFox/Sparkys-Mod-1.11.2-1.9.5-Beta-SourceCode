...
public class BlockRuinsWallGapRight extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallGapRight" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallGapRight;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallGapRight() {							  	  //===================================================================================================================//
