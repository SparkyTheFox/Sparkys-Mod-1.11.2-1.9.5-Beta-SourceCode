...
public class BlockRuinsWallGapLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallGapLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallGapLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallGapLeft() {							  	  //===================================================================================================================//
