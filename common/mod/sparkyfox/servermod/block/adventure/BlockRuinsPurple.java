...
public class BlockRuinsPurple extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsPurple" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsPurple;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsPurple() {							  		  //===================================================================================================================//
