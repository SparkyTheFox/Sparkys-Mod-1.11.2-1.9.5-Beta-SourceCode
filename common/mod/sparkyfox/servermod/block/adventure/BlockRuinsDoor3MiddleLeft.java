...
public class BlockRuinsDoor3MiddleLeft extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsDoor3MiddleLeft" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsDoor3MiddleLeft;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsDoor3MiddleLeft() {							  	  //===================================================================================================================//
