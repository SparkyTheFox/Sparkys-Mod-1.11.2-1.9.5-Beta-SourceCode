...
public class BlockRuinsPad extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsPad" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsPad;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsPad() {							  	  //===================================================================================================================//
