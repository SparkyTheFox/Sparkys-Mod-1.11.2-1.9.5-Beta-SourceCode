...
public class BlockRuinsStairs extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsStairs" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsStairs;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsStairs() {							  	  //===================================================================================================================//
