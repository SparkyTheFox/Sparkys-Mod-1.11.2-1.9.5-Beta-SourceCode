...
public class BlockRuinsCircle3 extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsCircle3" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsCircle3;  // BrassBlock.ServerMod:BrassBlock
	}
	


	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsCircle3() {							  	  //===================================================================================================================//
		super(Material.BARRIER);					  			 // The Material determines some properties of the block.															  //
		this.setBlockUnbreakable();				 				// The hardness determines how long a block takes to break. 5 is a bit high, most are around 3-3.					 //
