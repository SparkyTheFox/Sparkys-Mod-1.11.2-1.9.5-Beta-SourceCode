...
public class BlockRuinsWallArrows extends Block	 {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsWallArrows" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsWallArrows;  // BrassBlock.ServerMod:BrassBlock
	}
	

	 public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public BlockRuinsWallArrows() {							  	  //===================================================================================================================//
