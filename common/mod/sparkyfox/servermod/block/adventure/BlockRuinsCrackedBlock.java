...
public class BlockRuinsCrackedBlock extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "RuinsCrackedBlock" + ServerMod.RESOURCE_PREFIX + ModNames.RuinsCrackedBlock;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockRuinsCrackedBlock() {							  		  //===================================================================================================================//
