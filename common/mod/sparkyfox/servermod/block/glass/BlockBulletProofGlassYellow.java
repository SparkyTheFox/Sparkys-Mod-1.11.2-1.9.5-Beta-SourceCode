...
public class BlockBulletProofGlassYellow extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassYellow" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassYellow;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassYellow() {							  //===================================================================================================================//
