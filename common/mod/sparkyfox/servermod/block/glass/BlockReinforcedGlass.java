...
public class BlockReinforcedGlass extends Block {
	...
	public String getUnlocalizedName() {
		return "ReinforcedGlass" + ServerMod.RESOURCE_PREFIX + ModNames.ReinforcedGlass;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	...
	public BlockReinforcedGlass() {							  	  //===================================================================================================================//
		...
		this.setHardness(300.0f); 				 				// The hardness determines how long a block takes to break. 5 is a bit high, most are around 2-3.					 //
		this.setResistance(300.0F);     					   // Resistance to explosions.																							//
