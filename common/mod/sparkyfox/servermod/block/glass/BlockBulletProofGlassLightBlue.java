...
public class BlockBulletProofGlassLightBlue extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassLightBlue" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassLightBlue;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassLightBlue() {							  //===================================================================================================================//
