...
public class BlockBulletProofGlassPink extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassPink" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassPink;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassPink() {							  //===================================================================================================================//
