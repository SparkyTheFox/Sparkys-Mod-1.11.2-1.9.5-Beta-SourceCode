...
public class BlockBulletProofGlassRed extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassRed" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassRed;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassRed() {							  //===================================================================================================================//
