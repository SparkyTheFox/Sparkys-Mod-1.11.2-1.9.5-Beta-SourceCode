...
public class BlockBulletProofGlassBlue extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassBlue" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassBlue;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassBlue() {							  //===================================================================================================================//
