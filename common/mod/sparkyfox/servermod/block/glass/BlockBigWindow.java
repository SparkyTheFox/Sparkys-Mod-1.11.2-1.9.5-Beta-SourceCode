...
public class BlockBigWindow extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BigWindow" + ServerMod.RESOURCE_PREFIX + ModNames.BigWindow;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBigWindow() {							  //===================================================================================================================//
