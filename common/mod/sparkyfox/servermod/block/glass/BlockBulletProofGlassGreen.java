...
public class BlockBulletProofGlassGreen extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassGreen" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassGreen;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassGreen() {							  //===================================================================================================================//
