...
public class BlockBulletProofGlassWhite extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassWhite" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassWhite;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassWhite() {							  //===================================================================================================================//
