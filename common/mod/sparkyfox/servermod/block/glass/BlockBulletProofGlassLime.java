...
public class BlockBulletProofGlassLime extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassLime" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassLime;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassLime() {							  //===================================================================================================================//
