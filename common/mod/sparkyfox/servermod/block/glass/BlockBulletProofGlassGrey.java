...
public class BlockBulletProofGlassGrey extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassGrey" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassGrey;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassGrey() {							  //===================================================================================================================//
