...
public class BlockBulletProofGlassMagenta extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassMagenta" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassMagenta;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassMagenta() {							  //===================================================================================================================//
