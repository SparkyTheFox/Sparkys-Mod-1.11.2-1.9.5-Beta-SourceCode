...
public class BlockBulletProofGlassBrown extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassBrown" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassBrown;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassBrown() {							  //===================================================================================================================//
