...
public class BlockBulletProofGlassCyan extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassCyan" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassCyan;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassCyan() {							  //===================================================================================================================//
