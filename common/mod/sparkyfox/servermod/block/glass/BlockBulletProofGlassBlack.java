...
public class BlockBulletProofGlassBlack extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassBlack" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassBlack;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassBlack() {							  //===================================================================================================================//
