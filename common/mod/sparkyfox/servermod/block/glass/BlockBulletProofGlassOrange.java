...
public class BlockBulletProofGlassOrange extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassOrange" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassOrange;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassOrange() {							  //===================================================================================================================//
