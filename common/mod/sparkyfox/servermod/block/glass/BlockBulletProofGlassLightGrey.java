...
public class BlockBulletProofGlassLightGrey extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassLightGrey" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassLightGrey;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassLightGrey() {							  //===================================================================================================================//
