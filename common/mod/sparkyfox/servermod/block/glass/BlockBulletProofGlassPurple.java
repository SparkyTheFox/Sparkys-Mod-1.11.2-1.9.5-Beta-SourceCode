...
public class BlockBulletProofGlassPurple extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BulletProofGlassPurple" + ServerMod.RESOURCE_PREFIX + ModNames.BulletProofGlassPurple;  // TitaniumBlock.ServerMod:TitaniumBlock
	}
	


	public BlockBulletProofGlassPurple() {							  //===================================================================================================================//
