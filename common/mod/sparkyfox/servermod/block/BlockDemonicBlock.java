...
public class BlockDemonicBlock extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "DemonicBlock" + ServerMod.RESOURCE_PREFIX + ModNames.DemonicBlock;  // DemonicBlock.ServerMod:DemonicBlock
	}
	


	public BlockDemonicBlock() {							  	  	  //===================================================================================================================//
		...
		public void addRecipes() {
				...
				GameRegistry.addShapedRecipe(new ItemStack(this),"BBB", "BBB", "BBB", 'B', ModItems.DemonicIngot);
