...
public class BlockNickelBlock extends Block {
	...
	public String getUnlocalizedName() {
		return "NickelBlock" + ServerMod.RESOURCE_PREFIX + ModNames.NickelBlock;  // NickelBlock.ServerMod:NickelBlock
	}
	...
	public BlockNickelBlock() {							  	  	  //===================================================================================================================//
		...
		public void addRecipes() {
				...
				GameRegistry.addShapedRecipe(new ItemStack(this),"NNN", "NNN", "NNN", 'N', ModItems.NickelIngot);
