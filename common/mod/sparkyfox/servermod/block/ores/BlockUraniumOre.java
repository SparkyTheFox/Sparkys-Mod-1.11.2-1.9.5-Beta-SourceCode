...
public class BlockUraniumOre extends Block {
	...
	public String getUnlocalizedName() {
		return "UraniumOre" + ServerMod.RESOURCE_PREFIX + ModNames.UraniumOre;  // UraniumOre.ServerMod:UraniumOre
	}
	...
	public BlockUraniumOre() {								  	  //===================================================================================================================//
		...
		public void addRecipes() {
			GameRegistry.addSmelting(ModBlocks.UraniumOre, new ItemStack(ModItems.UraniumIngot), 1.0F);
		}
	}