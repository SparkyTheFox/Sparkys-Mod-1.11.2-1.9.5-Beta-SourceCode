...
public class BlockMagnesiumOre extends Block {
	...
	public String getUnlocalizedName() {
		return "MagnesiumOre" + ServerMod.RESOURCE_PREFIX + ModNames.MagnesiumOre;  // MagnesiumOre.ServerMod:MagnesiumOre
	}
	...
	public BlockMagnesiumOre() {								  //===================================================================================================================//
		...
		public void addRecipes() {
			GameRegistry.addSmelting(ModBlocks.MagnesiumOre, new ItemStack(ModItems.MagnesiumIngot), 1.0F);
		}
	}