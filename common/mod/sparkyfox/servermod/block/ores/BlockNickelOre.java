...
public class BlockNickelOre extends Block {
	...
	public String getUnlocalizedName() {
		return "NickelOre" + ServerMod.RESOURCE_PREFIX + ModNames.NickelOre;  // NickelOre.ServerMod:NickelOre
	}
	...
	public BlockNickelOre() {								  	  //===================================================================================================================//
		...
		public void addRecipes() {
			GameRegistry.addSmelting(ModBlocks.NickelOre, new ItemStack(ModItems.NickelIngot), 1.0F);
		}
	}