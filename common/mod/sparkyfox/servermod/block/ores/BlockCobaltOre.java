...
public class BlockCobaltOre extends Block {
	...
	public String getUnlocalizedName() {
		return "CobaltOre" + ServerMod.RESOURCE_PREFIX + ModNames.CobaltOre;  // CobaltOre.ServerMod:CobaltOre
	}
	...
	public BlockCobaltOre() {								  	  //===================================================================================================================//
		...
		public void addRecipes() {
			GameRegistry.addSmelting(ModBlocks.CobaltOre, new ItemStack(ModItems.CobaltIngot), 1.0F);
		}
	}