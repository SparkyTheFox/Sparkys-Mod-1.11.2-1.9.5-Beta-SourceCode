...
public class BlockIndustrialFreezer extends BlockContainer
{
    ...
    /**
     * Get the Item that this Block should drop when harvested.//DROPS
     */
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return Item.getItemFromBlock(ModBlocks.IndustrialFreezer);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModBlocks.IndustrialFreezer.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModBlocks.IndustrialFreezer.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
    ...
    {
        return new TileEntityIndustrialFreezer();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityIndustrialFreezer)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityIndustrialFreezer)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityIndustrialFreezer)tileentity);
    ...
    {
        return new ItemStack(ModBlocks.IndustrialFreezer);
    }
