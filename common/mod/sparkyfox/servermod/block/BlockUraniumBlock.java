...
public class BlockUraniumBlock extends Block {
	...
	public String getUnlocalizedName() {
		return "UraniumBlock" + ServerMod.RESOURCE_PREFIX + ModNames.UraniumBlock;  // UraniumBlock.ServerMod:UraniumBlock
	}
	...
	public BlockUraniumBlock() {							  	  //===================================================================================================================//
		...
		public void addRecipes() {
				...
				GameRegistry.addShapedRecipe(new ItemStack(this),"UUU", "UUU", "UUU", 'U', ModItems.UraniumIngot);
