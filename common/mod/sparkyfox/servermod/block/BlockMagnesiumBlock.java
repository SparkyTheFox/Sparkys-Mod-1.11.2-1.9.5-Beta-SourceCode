...
public class BlockMagnesiumBlock extends Block {
	...
	public String getUnlocalizedName() {
		return "MagnesiumBlock" + ServerMod.RESOURCE_PREFIX + ModNames.MagnesiumBlock;  // MagnesiumBlock.ServerMod:MagnesiumBlock
	}
	...
	public BlockMagnesiumBlock() {							  	  //===================================================================================================================//
		...
		public void addRecipes() {
				...
				GameRegistry.addShapedRecipe(new ItemStack(this),"MMM", "MMM", "MMM", 'M', ModItems.MagnesiumIngot);
