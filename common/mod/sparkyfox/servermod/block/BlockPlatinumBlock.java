...
public class BlockPlatinumBlock extends Block {
	...
	public String getUnlocalizedName() {
		return "PlatinumBlock" + ServerMod.RESOURCE_PREFIX + ModNames.PlatinumBlock;  // PlatinumBlock.ServerMod:PlatinumBlock
	}
	...
	public BlockPlatinumBlock() {							  	  //===================================================================================================================//
		...
		public void addRecipes() {
				...
				GameRegistry.addShapedRecipe(new ItemStack(this),"PPP", "PPP", "PPP", 'P', ModItems.PlatinumIngot);
