...
public class BlockBarrierWood extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BarrierWood" + ServerMod.RESOURCE_PREFIX + ModNames.BarrierWood;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockBarrierWood() {							  	  	  //===================================================================================================================//
