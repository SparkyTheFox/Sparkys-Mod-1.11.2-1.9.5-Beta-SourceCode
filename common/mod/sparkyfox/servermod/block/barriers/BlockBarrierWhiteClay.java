...
public class BlockBarrierWhiteClay extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BarrierWhiteClay" + ServerMod.RESOURCE_PREFIX + ModNames.BarrierWhiteClay;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockBarrierWhiteClay() {							  	  //===================================================================================================================//
