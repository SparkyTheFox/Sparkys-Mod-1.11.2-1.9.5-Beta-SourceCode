...
public class BlockBarrierRedClay extends Block {

	
	@Override
	public String getUnlocalizedName() {
		return "BarrierRedClay" + ServerMod.RESOURCE_PREFIX + ModNames.BarrierRedClay;  // BrassBlock.ServerMod:BrassBlock
	}
	


	public BlockBarrierRedClay() {							  	  //===================================================================================================================//
