...
public class SlotIndustrialFreezerOutput extends Slot
{
    /** The player that is using the GUI where this slot resides. */
    private final EntityPlayer player;
    private int removeCount;

    public SlotIndustrialFreezerOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
    ...
    protected void onCrafting(ItemStack stack)
    {
        ...
        if (!this.player.world.isRemote)
        {
            ...
            float f = IndustrialFreezerRecipes.instance().getFreezingExperience(stack);
