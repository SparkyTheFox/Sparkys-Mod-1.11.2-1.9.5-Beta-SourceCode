...
import net.minecraftforge.common.util.EnumHelper;
	...
	public static void Load() {
		...
		Item.ToolMaterial bronze = EnumHelper.addToolMaterial("BRONZE", 2, 170, 5.0F, 2.0F, 15);
		...
		bronze.setRepairItem(new ItemStack(ModFunItems.ingot_bronze));
	...
	bronze_staff = new ItemStaff(ModToolMaterial.BRONZE).register("bronze_staff");
	...
	bronze_trident = new ItemWeaponBasic(bronze).register("bronze_trident");
    ...
    bronze_sword = new ItemWeaponBasic(bronze).register("bronze_sword");
    ...
    bronze_shield_round = new ItemShieldBasic(ModToolMaterial.BRONZE).register("bronze_shield_round");
    ...
    bronze_shield = new ItemShieldBasic(ModToolMaterial.BRONZE).register("bronze_shield");
    ...
    tower_shield = new ItemShieldBasic(ModToolMaterial.IRON).register("tower_shield");
     ...
     bronze_spear = new ItemWeaponBasic(bronze, 2).register("bronze_spear");
     ...
     bronze_halberd = new ItemWeaponBasic(bronze).register("bronze_halberd");
     ...
     bronze_battleaxe = new ItemWeaponBasic(bronze).register("bronze_battleaxe");
     ...
     bronze_warhammer = new ItemWeaponBasic(bronze).register("bronze_warhammer");
     ...
     bronze_mace = new ItemWeaponBasic(bronze).register("bronze_mace");
     ...
     bronze_dagger = new ItemWeaponBasic(bronze, 2).register("bronze_dagger");
     bronze_dagger_reversed = new ItemWeaponBasic(bronze, 2).register("bronze_dagger_reversed");
    ...
    bronze_scythe = new ItemWeaponBasic(bronze).register("bronze_scythe");
    ...
    bronze_glaive = new ItemWeaponBasic(bronze).register("bronze_glaive");
    ...
    bronze_broadsword = new ItemWeaponBasic(bronze).register("bronze_broadsword");
