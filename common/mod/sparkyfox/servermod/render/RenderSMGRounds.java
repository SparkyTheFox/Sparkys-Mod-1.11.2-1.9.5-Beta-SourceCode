...
public class RenderSMGRounds<T extends EntityArrow> extends Render<T> {

	private static final ResourceLocation arrowTextures = new ResourceLocation("textures/entity/smgrounds.png");
	
	private static final Random rand = new Random();

	public RenderSMGRounds(RenderManager renderManager) {
		super(renderManager);
	}
